            ...
            <div className="b-form">
                <form id="form" ref="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className="b-form__row b-form__row_text">
                        <textarea spellCheck="false" name="text" className="b-form__control" placeholder="write your message" onChange={this.handleTextChange} value={this.state.text}></textarea>
                    </div>
                    <div className="b-form__row_submit">
                        <button type="submit" className="b-form__submit">Submit</button>
                    </div>
                </form>
            </div>
        )
